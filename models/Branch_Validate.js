jsh.App[modelid] = new (function(){
  ...
  this.previewPage = function(obj){
    ...
    jsh.System.OpenPageEditor(page_key, page_filename, page_template_id, { source: 'branch_validate', branch_id: xmodel.get('branch_id'), rawEditorDialog: '.'+xmodel.class+'_RawTextEditor', page_id: page_id  });
  }
