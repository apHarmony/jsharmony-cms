    ...
    var open = function (editor, templateList) {
      var createTemplates = function () {
        if (!templateList || templateList.length === 0) {
          var message = editor.translate('No web snippets defined.'+(!templateList ? '  Set defaultEditorConfig.webSnippetsPath in the CMS config.' : ''));
      ...
      var openDialog = function (templates) {
        ...
        var updateDialog = function (dialogApi, template, previewHtml) {
          ...
          if (!isIframeSnippet && (previewHtml||'').toString().trim()) {
