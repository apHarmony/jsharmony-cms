...
(function () {
    ...
    var getTemplates = function (editorSettings) {
      return editorSettings.webSnippets;
    };
    ...
    var getPreviewContent = function (editor, html, useIframe) {
      if (useIframe && html.indexOf('<html>') === -1) {
    ...
    var open = function (editor, templateList) {
      var createTemplates = function () {
        if (!templateList || templateList.length === 0) {
          var message = editor.translate('No web snippets defined.');
      ...
      var loadFailedAlert = function (api) {
        editor.windowManager.alert('Could not load the specified web snippet.', function () {
      ...
      var openDialog = function (templates) {
        ...
        var updateDialog = function (dialogApi, template, previewHtml) {
          ...
          var useIframe = /<\s*html(.|\r|\n)*<\s*body/.test(previewHtml);
          var content = getPreviewContent(editor, previewHtml, useIframe);
          var bodyItems = [
            {
              type: 'selectbox',
              name: 'template',
